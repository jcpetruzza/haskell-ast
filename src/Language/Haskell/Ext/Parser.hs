...
fromHseLiteral :: E.Literal l -> Literal l
fromHseLiteral lit = case lit of
        E.Char    l c rw    -> Char   l c rw
        E.String  l s rw    -> String l s rw
        E.Int     l i rw    -> Int    l i rw
        E.Frac    l r rw    -> Frac   l r rw
        E.PrimInt    l i rw -> PrimInt    l i rw
        E.PrimWord   l i rw -> PrimWord   l i rw
        E.PrimFloat  l r rw -> PrimFloat  l r rw
        E.PrimDouble l r rw -> PrimDouble l r rw
        E.PrimChar   l c rw -> PrimChar   l c rw
        E.PrimString l s rw -> PrimString l s rw
...
--fromHsePromoted :: E.Promoted l -> Promoted String l
--fromHsePromoted (E.PromotedInteger l int raw) = PromotedInteger l int raw
--fromHsePromoted (E.PromotedString l str raw) = PromotedString l str raw
--fromHsePromoted (E.PromotedCon l b qn)   = PromotedCon l b (fromHseQName qn)
--fromHsePromoted (E.PromotedList l b ps)  = PromotedList  l b (map fromHsePat ps)
--fromHsePromoted (E.PromotedTuple l ps) = PromotedTuple l (map fromHsePat ps)
--fromHsePromoted (E.PromotedUnit l)     = PromotedUnit l

-- fromHseIfAlt :: E.IfAlt l -> IfAlt String l
-- fromHseIfAlt (E.IfAlt l e1 e2) = IfAlt l (fromHseExp e1) (fromHseExp e2)
